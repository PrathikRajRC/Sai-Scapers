      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto mb-16 text-center">
          <p className="text-xl text-gray-700 mb-6 leading-relaxed">
            At Sai Scaper, we specialize in creating and maintaining breathtaking living environments tailored to your vision. Our services go beyond design—we provide regular maintenance to give you a completely hassle-free experience.
          </p>
